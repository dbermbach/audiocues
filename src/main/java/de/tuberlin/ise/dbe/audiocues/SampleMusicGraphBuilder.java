...
public class SampleMusicGraphBuilder {
	...
	public static MusicGraphNode buildGraph() {
		...
		intro[1].connectTo(allWithMelodyEnd, true);
		intro[1].connectTo(allWithoutMelodyEnd, true);
		intro[1].connectTo(bridgeMelodyWithEnd, true);
		intro[1].connectTo(bridgeMelodyNoEnd, true);
		bridgeMelodyWithEnd.connectTo(bridgeMelodyNoEnd, true);
		allWithMelodyEnd.connectTo(allWithoutMelodyEnd, true);
		allWithoutMelodyEnd.connectTo(bridgeNoMelody, false);
		MusicGraphNode[] otherIntro = buildIntro();
		allWithoutMelodyEnd.connectTo(otherIntro[0], true);
		otherIntro[1].connectTo(allWithMelodyEnd, true);
		allNoMelody.connectTo(allWithMelodyEnd, true);
		bridgeNoMelody.connectTo(bridgeMelodyWithEnd, true);
		bridgeMelodyNoEnd.connectTo(bridgeNoMelody, false);
		bridgeMelodyNoEnd.connectTo(allNoMelody, false);
